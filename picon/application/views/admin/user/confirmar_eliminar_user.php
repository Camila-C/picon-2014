...
<DIV class =" principal">
	...
	<!-- 	<FORM ACCEPT-CHARSET = "utf-8" ACTION = "<?php// echo base_url(); ?>usuarios_cont/modificacion_form" METHOD = "POST" enctype="multipart/form-data">
		...
		<INPUT TYPE = "hidden" NAME = "clave" SIZE = "40" MAXLENGTH="40" value = <?php echo $usuario -> clave ?>> <br>
		
		<INPUT TYPE = "button" ONCLICK = "location = '<?php echo base_url();?>admin_cont/administrar_users'" VALUE = Cancelar>
		<INPUT TYPE = "button" ONCLICK = "location = '<?php echo base_url();?>admin_cont/baja_user/<?php echo $usuario -> id; ?>'" VALUE = Eliminar> <br>
		</FIELDSET>
